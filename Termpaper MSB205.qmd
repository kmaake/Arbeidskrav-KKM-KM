...
```{r}
SDEM_2000 <- errorsarlm(mod3, data = kc_house_env_var_omit_2000, listw = kc_house_data_2000_W, 
...
```{r}
SLX_2000 <- lmSLX(mod3, data = kc_house_env_var_omit_2000, listw = kc_house_data_2000_W, 
                  Durbin =  as.formula(~ bedrooms + bathrooms + sqft_living + sqft_living15 +
...
```{r}
SEM_2000 <- errorsarlm(mod3, data = kc_house_env_var_omit_2000, listw = kc_house_data_2000_W, 
                       Durbin = FALSE)
```
